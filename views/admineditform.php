                ...
                <div class="mdl-cell mdl-cell--4-col">
                    <form id="displayaddformoptions" method="post" action="../db/updateform/addoption.php" onsubmit="return ValidateInput(this)">
                        ...
                        <table border="0">
                            ...
                            <tr>
                                <div class="mdl-textfield mdl-js-textfield">
                                    <input class="mdl-textfield__input" type="text" id="addInputType" name="addOptionType">
                                    <label class="mdl-textfield__label" for="addInputType">Input Type</label>
                                </div>
                            </tr>
                            <tr>
                                <div class="mdl-textfield mdl-js-textfield">
                            ...
                            <tr>
                                <td>
                                    <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" type="submit" id="addFormOptionButton" onclick="return ValidateInput();">
                                        Add Input
                                    </button>
                                </td>
                            </tr>
